...
<c:if test="${empty loadok}">
    <jsp:forward page="guanyu"/>
</c:if>
<ol class="breadcrumb">
    位置：
    <li><a href="#">单页管理</a></li>
    <li class="active">编辑关于我们</li>
</ol>
<div class="container">
    <form action="editguanyu" method="post">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <button type="submit"   class="btn btn-default" style="width: 100%;">修改关于我们</button>
            </div>
        </div>
    </form>
</div>
