...
--%>
    ...
    <div class="row" style="text-align: center;margin-top: 30px">
        <h2><c:out value="${data.work_name}" escapeXml="false"></c:out></h2>
        <p>发布日期：<c:out value="${data.work_date}" escapeXml="false"></c:out></p>
        <p>发布人：<c:out value="${data.work_member.username}"></c:out></p>
    </div>

    <hr>
    <div class="row"><c:out value="${data.work_value}" escapeXml="false;"></c:out></div>
